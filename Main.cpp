// SortingAlgs.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
#include <math.h>
#include <chrono>
#include <thread>
...
int main() {
	...
	sf::RenderWindow window(sf::VideoMode(960, 540), "Sorting Algorithms", sf::Style::Close);
